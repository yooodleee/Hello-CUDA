...
#define INDEX2ID(_ID, _X, _Y, _W) {_X=INDEX2X(_ID, _W); _Y=INDEX2Y(_ID, _W);}
...
#ifndef VTK_IS_NERROR
// #include "DS_common_def.h"
#define VTK_IS_NOERROR(p) (p->GetErrorGode()==vtkErrorCode::NoError ? true : false)
#endif
